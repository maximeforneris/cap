...
Elle est regeneree par `_commun/modeles/site.py`.

## Ce que ce depot ne contient pas

Ni corriges, ni fiches professeur, ni documents de travail. Les pages
des seances qui n'ont pas encore eu lieu n'y sont pas non plus : elles
s'ajoutent au fil de l'annee.
